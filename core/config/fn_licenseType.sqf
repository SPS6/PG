...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "ukla": {_var = "license_civ_ukla"};
			case "bl": {_var = "license_civ_bl"};
			case "utah": {_var = "license_civ_utah"};
			case "fs": {_var = "license_civ_fs"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_ukla": {_var = "ukla"};
			case "license_civ_bl": {_var = "bl"};
			case "license_civ_utah": {_var = "utah"};
			case "license_civ_fs": {_var = "fs"};
			default {_var = ""};
		};
	};
};
