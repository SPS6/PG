...
switch (_var) do
{
	...
	case "life_inv_prayer": {("Radiation Tablets")};
	...
	case "license_civ_bl": {("BL License")};
	case "license_civ_ukla": {("UKLA License")};
	case "license_civ_utah": {("UTAH License")};
	case "license_civ_fs": {("FS License")};
};
