...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\cops\apd_offroad.paa","cop"],
			["textures\medics\ems_offroad.paa","med"],
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\medics\ems_suv.paa","med"],
			["textures\rebels\rebel_suv.paa","reb"],
			["textures\cops\apd_suv.paa","cop"]
		];
	};
	...
	case "B_Quadbike_01_F":
	{
		...
		[
			...
			["textures\rebels\rebel_quadbike.paa","reb"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		_ret = 
		[
			["textures\cops\apd_hummingbird.paa","cop"],
	...
	case "O_Heli_Light_02_unarmed_F":
	{
		...
		[
			...
			["textures\cops\apd_orca.paa","cop"],
			["textures\rebels\rebel_orca.paa","reb"],
			["textures\medics\ems_orca.paa","med"]
		];
	};
	...
	case "O_MRAP_02_F":
	{
		_ret = 
		[
			["textures\rebels\rebel_ifrit_0.paa","reb","textures\rebels\rebel_ifrit_1.paa"]
		];
	};
	...
	case "I_Heli_light_03_unarmed_F":
	{
		_ret = 
		[
			["textures\medics\ems_hellcat.paa","med"],
			["textures\cops\apd_hellcat.paa","cop"],
