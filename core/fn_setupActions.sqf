...
life_actions = life_actions + [player addAction["Rob Person",life_fnc_robAction,"",0,false,false,"",'
	...
	case West:
	{
		// Nano EMP Little Bird
		 life_actions = life_actions + [player addAction ["<t color = '#FF0000'>Open EMP Operator Console</t>",life_fnc_openEmpMenu,[],8,false,false,"",'[_this] call life_fnc_isEmpOperator']];
	}
};