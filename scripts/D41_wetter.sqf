		...
		if (isDedicated) then
			{
				...
				if(D41_ChanceN >=0 && D41_ChanceN <= 0 && D41_RegenCounter == 0) then
					{
				...
				if(D41_ChanceN >=0 && D41_ChanceN <= 0 && D41_RegenCounter == 1) then {D41_ChanceN = 36};

				if(D41_ChanceN >=0 && D41_ChanceN <= 0) then
				{
				...
				if(D41_ChanceN >=0 && D41_ChanceN <= 100) then
				{
